...
import com.bornfire.xbrl.entities.BCCYS.MANUAL_Audit_Entity;
import com.bornfire.xbrl.entities.BCCYS.MANUAL_Audit_Rep;
import com.bornfire.xbrl.entities.BCCYS.UserAuditLevel_Entity;
	...
	public AuthenticationSuccessHandler xbrlAuthSuccessHandle() {
		return new AuthenticationSuccessHandler() {
			...
			public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
				...
				if (roleId.equals("IT") || roleId.equals("HR") || roleId.equals("OP") || roleId.equals("AC")) {
