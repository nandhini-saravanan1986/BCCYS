...
import com.bornfire.xbrl.entities.BCCYS.AuditServicesEntity;
import com.bornfire.xbrl.entities.BCCYS.AuditServicesRep;
...
public class LoginServices {
	...
	public Iterable<UserProfile> getUsersList(String ROLEIDAC) {
		...
		} else if (ROLEIDAC.equals("RBR_ADMIN") || ROLEIDAC.equals("RBR_BRANCH")|| ROLEIDAC.equals("RBR"))  {
	...
	public String sendclientotp(String otp, String Roletype, UserProfile UserProfile) {
		...
		Smsserviceotp.setSmstext(
				"BCCYS Login OTP: " + otp + " . Please do not share this with anyone. Valid for one-time use only.");
